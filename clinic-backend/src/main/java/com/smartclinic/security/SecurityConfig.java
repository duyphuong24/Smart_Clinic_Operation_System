    ...
    public SecurityFilterChain apiFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/invoices/**", "/api/v1/payments/**").hasAnyRole("ADMIN", "CASHIER", "MANAGER", "PATIENT")
    ...
    public SecurityFilterChain webFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/staff/**", "/admin/services/**").hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .requestMatchers("/consultation/**", "/encounters/**").hasAnyRole("ADMIN", "DOCTOR")
